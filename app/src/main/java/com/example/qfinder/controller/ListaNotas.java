...
public class ListaNotas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.agregarNota).setOnClickListener(v -> {
            Intent intent = new Intent(ListaNotas.this, CrearNota.class);
            startActivity(intent);
        });
    }
    ...
    private void cargarNotasDesdeBD() {
        ...
        if (cursor.moveToFirst()) {
            do {
                String fecha = cursor.getString(cursor.getColumnIndexOrThrow(com.example.qfinder.model.DBHelper.COLUMN_FECHA));
                String descripcion = cursor.getString(cursor.getColumnIndexOrThrow(com.example.qfinder.model.DBHelper.COLUMN_DESCRIPCION));
